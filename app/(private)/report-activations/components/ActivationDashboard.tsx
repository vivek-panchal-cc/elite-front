...
const medals: Medal[] = [
  ...
  {
    name: 'Diamond',
    gradient: ' linear-gradient(90deg, #EBEFF9 27.68%, #D5DBEB 53.19%, #ECF0F9 71.09%)',
    color: 'bg-[#E2E2E2] text-gray-800',
...
const rewardData = [
  ...
  {
    target: 50,
    rewards: ['1 * Apple Watch Series 3', '2 * £2 Per Activation To Rewards Account'],
  },
  {
    target: 30,
    rewards: [
          ...
          <div className="mx-auto gap-6 py-8 sm:py-10 md:py-14 lg:py-16 px-5 sm:px-5 md:px-8 lg:px-[60px]">
            <div>
              ...
              <div className="xl:flex xl:flex-row xl:justify-end  xl:gap-[295px] lg:flex lg:flex-row lg:justify-end lg:gap-[150px]">
                <p className="text-center text-[32px] text-[#005198] font-bold mb-4">Dashboard</p>
              ...
              <div>
                ...
                <div className="hidden lg:block">
                  ...
                  <div className="grid grid-cols-[150px_repeat(auto-fit,minmax(100px,1fr))] lg:grid-cols-[160px_repeat(auto-fit,minmax(60px,1fr))] text-center text-sm font-semibold">
                    ...
                    {activationData.map((item, idx) => (
                      <div key={idx} className=" py-2 ml-8 justify-center items-center flex">
                ...
                text-center border-b-2 border-[rgba(0,0,0,0.1)]"
                  >
                    <div className="bg-[#F6F6F6] text-center p-5 text-[16px] text-[#000000] font-bold rounded-tl-[10px] rounded-tr-[10px] border-0">
                      Activation
                    </div>
                    {activationData.map((item, idx) => (
                      <div key={idx}>
                        <p className="p-6 bg-[#F6F6F6] text-[16px] font-medium ml-8 rounded-tl-[10px] rounded-tr-[10px] border-0">
                          {item.activation}
                        </p>
                      </div>
                    ))}
                ...
                text-center  border-t border-[rgba(0,0,0,0.1)] "
                  >
                    <div className="bg-[#F6F6F6] p-5 text-center text-[16px] text-[#000000] font-bold rounded-bl-[10px] rounded-br-[10px]">
                      First Top Up
                    </div>
                    {activationData.map((item, idx) => (
                      <div
                        key={idx}
                        className="bg-[#F6F6F6] p-6 text-[16px] font-medium ml-8 rounded-br-[10px] rounded-bl-[10px]"
                      >
                        {item.topup}
                      </div>
                    ))}
              ...
              <div>
                ...
                <div className="flex flex-col gap-6 w-80 mx-auto lg:gap-8 md:w-full lg:w-full">
                  <div className="w-full lg:w-full md:flex-row">
                    <RewardDropdown
                      items={medals?.map((item, index) => ({
                        ...item,
                        gradient: item.gradient ?? '',
                        renderContent: index === activeIndex ? renderActiveSection() : null,
                      }))}
              ...
              {/* contact card   */}
              <div className="bg-[#F6F6F6] p-3 border border-[#ED174B] rounded-2xl mt-10">
                <div
                ...
                >
                  ...
                  >
                    <span className="whitespace-nowrap">Contact Our</span>
                    <br className="hidden md:block" />
                    <span className="whitespace-nowrap"> Nearby Executive</span>
                  </h3>
               ...
               hover:bg-[var(--color-red-hover)] text-white 
