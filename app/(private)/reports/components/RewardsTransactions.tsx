...
const RewardsTransactions = () => {
  ...
  const RewardsTransactions = (
    <div>
      <p className="text-[22px] font-bold text-[var(--color-blue)] lg:text-[26px] text-center mb-5 lg:text-left">
        Rewards Transactions
      </p>
      <div className="flex flex-col   ">
        <div className="flex flex-col items-center md:flex md:flex-row md:justify-center lg:justify-end lg:items-end lg:gap-3 w-full">
          ...
          <div className="hidden lg:flex relative  items-center  border-1 border-[rgba(0,0,0,0.31)] rounded-4xl px-3 py-2 bg-[rgba(0,0,0,0.05)] ">
            <DropdownMenu>
        ...
        <div className="lg:hidden flex flex-row  gap-5  py-5 lg:p-0 justify-center items-center">
        ...
        {/* nav bar desktop  */}
        <div className="hidden  lg:flex  flex-row gap-6 py-5 lg:p-0 items-start mb-4">
          <nav className="flex flex-row gap-10">
            <div
        ...
        {/* mobile card */}
        <div className="lg:hidden w-[326px] md:w-[350px] mx-auto border-0 rounded-2xl py-4 px-8 bg-[#F6F6F6] grid grid-cols-2 gap-x-14 gap-y-4 text-center">
          {/* Row 1 */}
    ...
    <div>
      <div className="max-w-7xl mx-auto w-full">
        <div className="mx-auto gap-6 py-8 sm:py-10 md:py-14  px-4 sm:px-5 md:px-8 lg:px-[60px]">
          {RewardsTransactions}
          <div className="hidden lg:block"> {TransactionTable}</div>
        </div>
        ;
      </div>
    </div>
