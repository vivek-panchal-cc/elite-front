  ...
  return (
    <div className="py-10 px-4 sm:px-5 md:px-8 lg:px-[60px] bg-white rounded-tl-[40px] rounded-tr-[40px] lg:rounded-tl-[80px] lg:rounded-tr-[80px] mt-[-80px] relative">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="gap-6 grid grid-cols-1 lg:grid-cols-[462px_1fr]">
          <div
            className="rounded-2xl px- flex justify-center p-3 text-white flex-col items-center"
            style={{
          ...
          >
            ...
            <div className="grid gap-6">
              ...
              <div className="grid lg:grid-cols-2 gap-6 lg:h-[287px]">
                <div className="rounded-2xl flex justify-center p-3 text-white flex-col items-center bg-[#124A9F]">
