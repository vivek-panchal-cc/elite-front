...
const Transfer = () => {
  ...
  const renderActiveSection = () => {
    switch (activeIndex) {
      case 0:
        return <TransferRightComponent setIsOpen={setIsOpen} isMobile={isMobile} activeIndex={activeIndex} />;
      case 1:
        return <TransferRightComponent setIsOpen={setIsOpen} isMobile={isMobile} activeIndex={activeIndex} />;
      case 2:
        return <TransferRightComponent setIsOpen={setIsOpen} isMobile={isMobile} activeIndex={activeIndex} />;
              ...
              <div className="w-full md:w-1/3">
                <SidebarNav
                  items={sidebarNavItems?.map((item, index) => ({
                    ...item,
                    renderContent: isMobile && index === activeIndex ? renderActiveSection() : null,
                  }))}
