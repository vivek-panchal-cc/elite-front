...
export const labels = {
  ...
  profile: {
    ...
    profileEmail: "sims@elitemobile.com",
    profilePhone: "01827307777",
    id: "ID",
    amount: "Amount",
    ...
    repDetails: "My Rep Details",
    rewardWallet: "My Rewards/Elite Wallet",
    ...
    shipping: {
      ...
      sameAsBillingAdd: "Same as Billing Address",
      firstName: "First Name",
      telephone: "Telephone",
      lastName: "Last Name",
      cityOrTown: "City/Town",
    ...
    profileOrderHistoryLabel: {
      ...
      orderHistoryDetails: {
        order: "Order",
        placedOn: "Was Placed On",
        currently: "And Is Currently",
        product: "Product",
        total: "Total",
        orderNo: "Order Number : ",
        orderDate: "Date : ",
  ...
  footer: {
    sections: {
      ...
      call: "Call:",
      dealerRegistrationNumber: "+44 (0) 17 8521 6850",
    },
    contact: {
      phone: "+44 (0) 1827 307 777",
      infoEmail: "sims@elitemobile.com",
      email: "Email:",
      dealerEmailAdd: "dealers@elitemobile.com",
      corpEmail: "corporate@elitemobile.com",
      corporatePhone: "+44 (0) 17 8521 6850",
    },
    newsletter: {
      title: "Newsletter",
      description:
  ...
  reports: {
    ...
    rewardTrans: "Rewards Transactions",
    ...
    dbAmount: "Debit Amount",
    balAmount: "Balance Amount",
    desc: "Description",
    statListing: "Reward Points Stats Listing",
    enterPoints: "Enter Reward Points To Redeem",
    redeemPts: "Redeem Points",
  ...
  transfer: {
    ...
    vapeJucceTitle: "Transfer to Your <br /> Vape Jucce Account",
    vapeJucceDesc:
